# [MEMORY.md](http://MEMORY.md) — Long-Term Context
...
- Email: [rileygcolley@icloud.com](mailto:rileygcolley@icloud.com)
...
- [Claude.ai](http://Claude.ai) reads via GitHub raw URL or Desktop Commander
...
- iPhone — captures, [Claude.ai](http://Claude.ai) iOS, ChatGPT, Gemini
...
- [**Claude.ai**](http://Claude.ai) — Lead Strategist. Planning, design, long-form thinking.
