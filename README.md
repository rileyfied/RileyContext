# RileyContext Public Agent Context
...
- `Last Updated` records the latest successful pipeline publication date. The separate `Status verified through` marker records project-evidence freshness.
- Capture bodies, project files, local paths, runtime indexes, and source archives are not published here.

The full working repository is private. Historical clones, forks, and third-party caches created before the 2026-08-01 privacy migration may remain outside Riley's control.
